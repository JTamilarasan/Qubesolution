...
import { Alert, Box, Button, Card, CardContent, Chip, LinearProgress, Stack, Step, StepLabel, Stepper, TableCell, TableRow, Typography } from '@mui/material'
...
function EmployeeImportPage() {
  ...
  return <Stack spacing={3}>
    ...
    <Card variant="outlined"><CardContent sx={{ p: { xs: 2, sm: 3 } }}>
      ...
      {complete && <Alert severity="success">{valid.length} employees were imported successfully.</Alert>}
