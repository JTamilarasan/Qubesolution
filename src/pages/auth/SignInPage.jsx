...
function SignInPage() {
  ...
  return (
    <AuthLayout>
      <AuthHeader title="Welcome back" description="Sign in to continue to Excelocom." />
      <Stack component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 3.5 }}>
        ...
        <Stack direction="row" alignItems="center" justifyContent="center" gap={.75} flexWrap="wrap" sx={{ mt: 2.25 }}>
          <Typography component="span" color="text.secondary" sx={{ fontSize: 14 }}>New to Excelocom?</Typography>
